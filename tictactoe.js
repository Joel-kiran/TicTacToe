...
import { StyleSheet, Text, TextInput, View, TouchableHighlight, StatusBar } from 'react-native';
...
export default function TicTacToe() {
  ...
  useEffect(() => {
    ...
    if (playerWon ==0 && second!=null && fifth!=null && eighth!=null){
      if (second==fifth && fifth==eighth){
        playerWon = 1
        if (second=='X') {
          alert("Player X Won")
          resetState()
